...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Background Pattern Overlay — lightweight CSS gradient */}
      ...
      <div className="relative z-20 mx-auto flex h-full max-w-7xl flex-col justify-center px-6 text-center sm:px-12 lg:px-24">
        ...
        >
          <button 
            className="px-8 py-4 bg-teal-500 hover:bg-teal-600 text-white rounded-lg font-semibold text-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
            onClick={() => {
          ...
          <button 
            className="px-8 py-4 border-2 border-white/30 hover:bg-white/10 text-white rounded-lg font-semibold text-lg transition-colors duration-200"
            onClick={() => {
        ...
        >
          <div className="text-center p-6 rounded-lg bg-white/10 border border-white/20">
